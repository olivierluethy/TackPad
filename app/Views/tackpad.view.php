            ...
            <td>
                <main>
                    ...
                    <form action="create" method="POST">
                        ...
                        <input type="text" id="aufgabe" name="notice" placeholder="Aufgabe">
                        <input type="date" id="date" name="date" placeholder="Datum eingeben">
                        <button class="hinzufuegen" type="submit"><i class="fas fa-plus"></i> Aufgabe
                            hinzufügen</button>
                    </form>
                    <p id="warningTitel"></p>
